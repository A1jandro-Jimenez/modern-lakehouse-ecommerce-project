...
a data lakehouse. The goal of a data lakehouse is to provide a reliable, scalable, cost-efficient, single unified source of truth. It combines the low cost cloud object store
like (like S3 or ADLS) and combines it with the high-performance management and governance of a data warehouse in order to achive its goal. It is designed to eliminate the need for maintaining two separate, 
...
- Provide qulity checks trhoughout transfomations and stages
